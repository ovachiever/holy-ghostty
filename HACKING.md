...
If you'd like to work on Ghostty or implement new features, start here.
...
If you're using AI assistance with Ghostty, you are still responsible for
understanding the code you produce and for disclosing AI assistance where
required by the contribution policy.

> [!WARNING]
>
> We expect contributors using AI assistance to disclose that usage where
> their workflow requires it and to understand the code that is produced
