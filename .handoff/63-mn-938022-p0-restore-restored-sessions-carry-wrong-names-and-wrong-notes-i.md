...
scope: '[P0][RESTORE] Restored sessions carry WRONG names and WRONG notes — identity crossed rows during the 2026-08-12 batch restore'
inputs: []
binding: sha256:9804c8edd94162aabc810cda9ca42ca590272b6d04e5f41e15f2850fc86588ff
---

# Handoff: [P0][RESTORE] Restored sessions carry WRONG names and WRONG notes — identity crossed rows during the 2026-08-12 batch restore
...
```bash
agent-do manna claim mn-938022
```

## Scope

[P0][RESTORE] Restored sessions carry WRONG names and WRONG notes — identity crossed rows during the 2026-08-12 batch restore
...
3. Seal changes with `agent-do manna handoff seal mn-938022`.
4. Commit with `Manna: mn-938022` and run `agent-do manna done mn-938022` only after the work is verified.
