...
scope: Handoff wiring + end-to-end resume verification
inputs: []
binding: sha256:7a69ebfb4a688253d7905e84e6b557179cca645b7f8ee705604edd1771b89427
---

# Handoff: Handoff wiring + end-to-end resume verification
...
```bash
agent-do manna claim mn-a98f88
```

## Scope

Handoff wiring + end-to-end resume verification
...
3. Seal changes with `agent-do manna handoff seal mn-a98f88`.
4. Commit with `Manna: mn-a98f88` and run `agent-do manna done mn-a98f88` only after the work is verified.
